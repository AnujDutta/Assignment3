...
Route::get('/taskjob', [SessionsController::class, 'job']);
...
Route::post('/login', [SessionsController::class, 'login'])->name('slogin');
Route::get('/addnewtasks', [SessionsController::class, 'addjob']);
Route::resources([
